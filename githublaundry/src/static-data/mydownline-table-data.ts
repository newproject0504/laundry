export const mydownlineTableLabels = [
  {
    text: 'New',
...
export const mydownlineTableData = [
  {
    id: 0,
    ...
    labels: [mydownlineTableLabels[0], mydownlineTableLabels[1]]
  },
 
  {
    ...
    labels: [mydownlineTableLabels[1]]
  }
];
