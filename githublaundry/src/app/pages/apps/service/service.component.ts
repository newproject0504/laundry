...
import { serviceData, serviceLabels } from '../../../../static-data/service-data';
...
export class ServiceComponent implements OnInit, AfterViewInit {
  ...
  columns: TableColumn<Customer>[] = [
   /* { label: 'Checkbox', property: 'checkbox', type: 'checkbox', visible: true },
    ...
    { label: 'SERVICE NAME', property: 'lastName', type: 'text', visible: true, cssClasses: ['text-secondary', 'font-medium'] },
 ...
 { label: 'STATUS', property: 'labels', type: 'button', visible: false },
   ...
   */
  getData() {
    return of(serviceData.map(customer => new Customer(customer)));
  }
