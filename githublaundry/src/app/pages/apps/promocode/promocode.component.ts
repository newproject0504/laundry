...
import { promocodeData, promocodeLabels } from '../../../../static-data/promocode-data';
...
export class PromocodeComponent implements OnInit, AfterViewInit {
  ...
  columns: TableColumn<Customer>[] = [
   /* { label: 'Checkbox', property: 'checkbox', type: 'checkbox', visible: true },
    ...
    { label: 'PROMO CODE NAME', property: 'lastName', type: 'text', visible: true, cssClasses: ['text-secondary', 'font-medium'] },
    { label: 'PROMO CODE ', property: 'phoneNumber', type: 'text', visible: true, cssClasses: ['text-secondary', 'font-medium'] },
    { label: 'PROMO CODE', property: 'zipcode', type: 'text', visible: true, cssClasses: ['text-secondary', 'font-medium'] },
 ...
 { label: 'STATUS', property: 'labels', type: 'button', visible: false },
   ...
   */
  getData() {
    return of(promocodeData.map(customer => new Customer(customer)));
  }
