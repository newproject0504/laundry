...
import { usersData, usersLabels } from '../../../../static-data/users-data';
...
export class UsersComponent implements OnInit, AfterViewInit {
  ...
  columns: TableColumn<Customer>[] = [
   /* { label: 'Checkbox', property: 'checkbox', type: 'checkbox', visible: true },
    ...
    { label: 'USER NAME', property: 'lastName', type: 'text', visible: true, cssClasses: ['text-secondary', 'font-medium'] },
    { label: 'USER MOBILE NO', property: 'phoneNumber', type: 'text', visible: true, cssClasses: ['text-secondary', 'font-medium'] },
 ...
 { label: 'STATUS', property: 'labels', type: 'button', visible: false },
   ...
   */
  getData() {
    return of(usersData.map(customer => new Customer(customer)));
  }
