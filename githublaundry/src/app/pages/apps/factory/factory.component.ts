...
import { factoryData, factoryLabels } from '../../../../static-data/factory-data';
...
export class FactoryComponent implements OnInit, AfterViewInit {
  ...
  columns: TableColumn<Customer>[] = [
   /* { label: 'Checkbox', property: 'checkbox', type: 'checkbox', visible: true },
    ...
    { label: 'FACTORY', property: 'lastName', type: 'text', visible: true, cssClasses: ['text-secondary', 'font-medium'] },
    { label: 'STORE', property: 'phoneNumber', type: 'text', visible: true, cssClasses: ['text-secondary', 'font-medium'] },
    { label: 'USER', property: 'city', type: 'text', visible: true, cssClasses: ['text-secondary', 'font-medium'] },
    
    { label: 'PASSWORD', property: 'zipcode', type: 'text', visible: true, cssClasses: ['text-secondary', 'font-medium'] },
 ...
 { label: 'STATUS', property: 'labels', type: 'button', visible: false },
   ...
   */
  getData() {
    return of(factoryData.map(customer => new Customer(customer)));
  }
