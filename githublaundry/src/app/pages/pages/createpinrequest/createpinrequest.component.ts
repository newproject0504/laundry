...
@Component({
  selector: 'vex-createpinrequest',
  templateUrl: './createpinrequest.component.html',
  styleUrls: ['./createpinrequest.component.scss'],
...
export class CreatepinrequestComponent implements OnInit {
